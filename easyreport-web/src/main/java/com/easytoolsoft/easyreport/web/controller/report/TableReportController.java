...
public class TableReportController {
	...
	private Logger log = LoggerFactory.getLogger(TableReportController.class);
	...
	public void exportToExcel(String uid, String name, String htmlText, HttpServletRequest request,
