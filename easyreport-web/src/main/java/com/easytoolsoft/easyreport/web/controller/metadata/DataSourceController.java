...
public class DataSourceController extends BaseController<IDataSourceService, DataSource, DataSourceExample> {
	...
	public JsonResult testConnection(Integer id) throws SQLException {
		...
		result.setSuccess(this.service.testConnection(dsPo.getJdbcUrl(), dsPo.getUser(), dsPo.getPassword()));
		return result;
	}
