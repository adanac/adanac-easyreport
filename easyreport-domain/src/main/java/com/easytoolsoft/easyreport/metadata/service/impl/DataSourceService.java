...
public class DataSourceService extends AbstractCrudService<IDataSourceDao, DataSource, DataSourceExample>
		implements IDataSourceService {

	private Logger log = LoggerFactory.getLogger(DataSourceService.class);
